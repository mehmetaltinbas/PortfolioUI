...
function ExperienceUpdateForm({ fetchUserData, toggleForm, isHidden, handleChange, handleSubmit, selectedExperience, firstExperience }) {
    ...
    return (
        <form id="experienceUpdateForm" onSubmit={(e) => handleSubmit(e, selectedExperience._id)}
        ...
        flex flex-col justify-center items-center gap-2`}>
            ...
            <div className="flex justify-start items-center gap-2">
                ...
                <input id="isCurrent" type="checkbox" name="isCurrent" checked={formData.isCurrent} onChange={handleChange} placeholder="isCurrent..."
                className="border p-2 rounded-full" />
            </div>
            <div className="flex justify-start items-center gap-2">
