...
function ContactUpdateForm({ fetchUserData, isHidden, toggleContactUpdateForm, contactUpdateFormData, setContactUpdateFormData }) {
    ...
    return (
        <form id="contactUpdateForm" onSubmit={(e) => handleContactUpdateSubmit(e, contactUpdateFormData._id)} className={`absolute flex flex-col justify-center items-center ${isHidden ? 'hidden' : ''} bg-white p-6 rounded-2xl shadow-md border
