...
function ExperienceSection({ fetchUserData, user, selectedExperience, SelectExperience, toggleExperienceCreateForm, toggleExperienceUpdateForm }) {
    ...
    async function handleActivityCreationSubmit(e, experienceId) {
        ...
        try {
            ...
            alert(response.message);
            setActivityCreateFromData({ ...activityCreateFormData, activity: '' });
            fetchUserData();
        } catch (error) {
            console.error("Error:", error.message);
        }
                ...
                <div className="w-full flex justify-center items-start gap-2">
                    ...
                    <div className={`w-full flex flex-col justify-start items-start gap-2`}>
                        ...
                        <form onSubmit={(e) => handleActivityCreationSubmit(e, selectedExperience._id)} className="w-full flex justify-center items-center gap-2">
                            <textarea id="activity" name="activity" value={activityCreateFormData.activity} onChange={handleActivityChange} placeholder="activity..."
