...
function Contact() {
    ...
    return (
        <form onSubmit={handleSubmit} className="bg-white p-6 flex flex-col justify-center items-center gap-2">
            ...
            className="w-full px-4 py-2 mb-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 h-32"></textarea>
            <button  type="submit"  className="py-1 px-4 border-[1px] border-gray rounded-full 
            hover:border-black">Submit</button>
        </form>
    );
}
