...
function AdminHome() {
    ...
    const [isContactCreateFormHidden, setIsContactCreateFormHidden] =
        useState(true);
    const [isContactUpdateFormHidden, setIsContactUpdateFormHidden] =
        useState(true);
    ...
    return (
        <div>
            ...
            <ContactInfoSection
                fetchUserData={fetchUserData}
                user={user}
                toggleContactCreateForm={toggleContactCreateForm}
                toggleContactUpdateForm={toggleContactUpdateForm}
            />

            <ContactCreateForm
                fetchUserData={fetchUserData}
                isHidden={isContactCreateFormHidden}
                toggleContactCreateForm={toggleContactCreateForm}
            />

            <ContactUpdateForm
                fetchUserData={fetchUserData}
                isHidden={isContactUpdateFormHidden}
                toggleContactUpdateForm={toggleContactUpdateForm}
                contactUpdateFormData={contactUpdateFormData}
                setContactUpdateFormData={setContactUpdateFormData}
            />
        </div>
    );
}
